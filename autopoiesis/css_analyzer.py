...
@dataclass
class CssAnalyzerResult:
    """Result of css analyzer operation."""
    success: bool
    data: Dict[str, Any]
    message: str = ""
...
class CssAnalyzer:
    ...
    def run(self, target: Any) -> CssAnalyzerResult:
        """
        ...
        Returns:
            CssAnalyzerResult with outcome
        """
        if target is None:
            return CssAnalyzerResult(
                success=False,
                data={},
