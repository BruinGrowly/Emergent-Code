...
@dataclass
class HtmlAnalyzerResult:
    """Result of html analyzer operation."""
    success: bool
    data: Dict[str, Any]
    message: str = ""
...
class HtmlAnalyzer:
    ...
    def run(self, target: Any) -> HtmlAnalyzerResult:
        """
        ...
        Returns:
            HtmlAnalyzerResult with outcome
        """
        if target is None:
            return HtmlAnalyzerResult(
                success=False,
                data={},
