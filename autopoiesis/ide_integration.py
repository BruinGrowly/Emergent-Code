...
@dataclass
class IdeIntegrationResult:
    """Result of ide integration operation."""
    success: bool
    data: Dict[str, Any]
    message: str = ""
...
class IdeIntegration:
    ...
    def run(self, target: Any) -> IdeIntegrationResult:
        """
        ...
        Returns:
            IdeIntegrationResult with outcome
        """
        if target is None:
            return IdeIntegrationResult(
                success=False,
                data={},
